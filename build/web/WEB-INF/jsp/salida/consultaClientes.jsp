...
<body onLoad="mostrarMensajes();">
	...
	<div id="DIAnetContainer">
		...
		<form name="MWEBFilterProveedorForm" method="POST" action="#">
                    <!--<input type="hidden" name="pagina" value="irClientes">-->
			...
			<div class="dianet-mrg-bottom-15">
				<div class="dianet-div-align-left">
					...
					<input type="button" name="" value="Limpiar búsqueda" onclick="btLimpiarBusquedaClientes();" class="boton">
					<input type="submit" value="Buscar" class="boton">
                                        
					
					
						<input type="button" name="" value="Volver" onclick="irConsultaEntrega();" class="boton">
		...
		<%
                ...
                if(codigo!=null){ 
                    ...
                    prov = conprov.getCliente(id_clte,codigo,nombre);
            ...
            <table id="page" cellpadding="3" cellspacing="5">
                <tr>
                    ...
                    <td><a class="dianet-nav-listado" id="pageFist"
                           onclick="irPage(0, 'DIAnetTableListadoClientes', '');
                                                       return false;"
                           href="#">&lsaquo;&lsaquo;</a></td>
                    <!- anterior pag -->
                    <td><a class="dianet-nav-listado" id="pagePrevious"
                           onclick="irPage('previous', 'DIAnetTableListadoClientes', '');
                                                       return false;"
                           href="#">&lsaquo;</a></td>
                    <!--<td id="page1"
                    ...
                    <!- siguiente pag -->
                    <td><a class="dianet-nav-listado" id="pagePrevious"
                           onclick="irPage('next', 'DIAnetTableListadoClientes', '');
                                                       return false;"
                           href="#">&rsaquo;</a></td>
                    <!- ultima pag -->
                    <td><a class="dianet-nav-listado"
                           onclick="irPage(2 - 1, 'DIAnetTableListadoClientes', '');
                                                       return false;"
                           href="#">&raquo;</a></td>
...
<%
    ...
    //if(codigo!=null){
        ...
        if(pagina.equals("irClientes")){
            pagina="";
        }
        if(pagina.equals("irClientesNEp")){
            pagina="nuevaep";
        }
        ...
        for (int i=0;i < prov.size();i++){
            %>
            <tr> 
            <td class='padding-left-10'><%=prov.get(i).getShip_to()%></td> 
            ...
            <td class='padding-left-10'><a href="#" onclick="irSeleccionarClienteEntrega('<%=prov.get(i).getShip_to() %>','<%=pagina %>','<%=codSeguimiento %>','<%=comentario %>',);">Seleccionar</a></td> 
            </tr>
            <%
        }
    }else{
