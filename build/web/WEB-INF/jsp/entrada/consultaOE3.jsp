...
<script language="javascript">
	...
	<div id="DIAnetContainer">
		...
		<div id="DIAnetBreadCrumbs">
			...
			<img src="imagenes/icon-bread-crumbs.gif" alt=""> <a href="#" onclick="irConsultaOrdenesEntrada();" class="home"> Consulta Ordenes de Entrada
		...
		<div class="dianet-mrg-bottom-15">
			<div class="dianet-div-align-left">
				<input type="button" name="" value="Volver" onclick="btVolverOE();" class="boton">
				...
				<tbody><tr>
					...
					<th width="85">Estado</th>
                                ...
                                <%
                                    ...
                                    oe = conoe.getOrdenesEntrada(id_clte,"",codOE,"","","");
...
<%
    LinkedList<DetalleOrdenEntrada> oeD;    
    ConsultasMnh conoeD = new ConsultasMnh();

    oeD = conoeD.getDetalleOrdenEntrada(codOE);
						...
						<table id="DIAnetTableProductosOrdenes" class="table-autopage:5" cellspacing="1" cellpadding="3">
							<thead id="orderHead">
								<tr>
									...
									<th width="100" class="">Cantidad Recepcionada</th>
								</tr>
							</thead>
							<tbody id="orderBody">
