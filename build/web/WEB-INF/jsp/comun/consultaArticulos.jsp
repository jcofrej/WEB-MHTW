...
<%
    String codSeguimiento="",comentario="",proveedor=""; 
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <SCRIPT LANGUAGE="JavaScript">
            ...
            {
                document.getElementById("codSeguimiento").value='<%=codSeguimiento %>';
    ...
    <body onLoad="mostrarMensajes();">
        ...
        <div id="DIAnetContainer">
            ...
            <div id="DIAnetBreadCrumbs">
                ...
                <a href="#" onclick="irConsultaOrdenesEntrada();" class="home"> Consulta Ordenes Entrada
                </a>
                <img src="imagenes/icon-bread-crumbs.gif" alt="" />
            ...
            <form name="MWEBFilterArticulosForm" method="POST" action="#">
                ...
                <input id="origen" type="hidden" name="origen" value="<%=origen %>">
                <input id="codSeguimiento" type="hidden" name="codSeguimiento" value="<%=codSeguimiento %>">
                <input id="comentario" type="hidden" name="comentario" value="<%=comentario %>">
                <input id="proveedor" type="hidden" name="proveedor" value="<%=proveedor %>">
                ...
                <div class="dianet-mrg-bottom-15">
                    <div class="dianet-div-align-left">
                        ...
                        <input type="button" name="" value="Volver" onclick="btVolverAltaOE('nuevaoe');" class="boton">
                ...
                <table cellspacing="1" cellpadding="3"
                    ...
                    <tr>
                        <td><input id="codigoArticuloPropietario"
                                   name="codigoArticuloPropietario" style="width: 98%" maxlength="15"
                            ...
                            <table id="DIAnetTableListadoArticulos"
                                ...
                                <tbody id="orderBody">
                                    ...
                                    <tr>
                                        ...
                                        <td class="padding-left-10"><a href="#" onclick="irSeleccionarArticulo('<%=arti.get(i).getCodArt()%>','<%=arti.get(i).getCodMh()%>',
                                                                       '<%=arti.get(i).getDescripcion()%>','<%=arti.get(i).getCategoria()%>','irArticuloNOe','irArticuloNOe',
