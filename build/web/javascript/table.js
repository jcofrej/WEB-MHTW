...
var Table = (function(){
	...
	var table = {
		...
		PageCurrent:"table-page-current:",
	...
	*/
	...
	table.autopage = function(t,args) {
		...
		if (tdata.pagesize) {
			...
			if ( classValue(t,table.PageCurrent) != undefined) {
				return table.page(t,classValue(t,table.PageCurrent)-1,args);
			} else {
