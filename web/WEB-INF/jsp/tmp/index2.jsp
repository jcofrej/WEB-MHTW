...
<html><head>
    ...
    <body>
        ...
        <div id="DIAnetContainer">
            ...
            <div id="DIAnetContainerHeader">
                <table width="100%">
                    <tbody><tr>
                            ...
                            <td align="center"><div style="color: #FFFFFF; font-size: 24px;">WEBTW-MH</div></td>
                ...
                <div id="DIAnetContainerContent">
                    <form name="MWEBLoginForm" method="POST" action="/validarServlet.do">
            ...
            </div></div><div id="extension-kmmojbkhfhninkelnlcnliacgncnnikf-installed"></div></body></html>